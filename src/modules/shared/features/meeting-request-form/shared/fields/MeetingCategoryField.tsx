...
export function MeetingCategoryField({ meetingType, disabled }: Props) {
  ...
  return (
    <FormField label="فئة الاجتماع" name="meeting_classification" required errors={errors} colSpan={4}>
