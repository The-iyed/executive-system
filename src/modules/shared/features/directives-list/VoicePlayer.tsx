  ...
  return (
    <div className="flex items-center gap-2.5 w-full">
      ...
      <div className="flex-1 flex items-center gap-2 min-w-0">
        <div ref={progressRef} onClick={handleSeek} className="flex-1 h-1.5 rounded-full bg-border/60 cursor-pointer overflow-hidden">
          <div className="h-full rounded-full bg-primary transition-[width] duration-100" style={{ width: `${progress}%`, float: 'right' }} />
        </div>
