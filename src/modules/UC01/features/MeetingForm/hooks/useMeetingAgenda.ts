...
import type { Step1ErrorKey } from './useStep1BasicInfo';
...
export interface UseMeetingAgendaParams {
  agenda: NonNullable<Step1BasicInfoFormData['meetingAgenda']>;
  setFormData: React.Dispatch<React.SetStateAction<Partial<Step1BasicInfoFormData>>>;
  setErrors: React.Dispatch<React.SetStateAction<Partial<Record<Step1ErrorKey, string>>>>;
