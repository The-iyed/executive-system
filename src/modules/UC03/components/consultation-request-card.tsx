...
export interface ConsultationRequestCardData {
  id: string;
...
export interface ConsultationRequestCardProps {
  request: ConsultationRequestCardData;
  onView?: () => void;
  onDetails?: () => void;
  className?: string;
}
...
export const ConsultationRequestCard: React.FC<ConsultationRequestCardProps> = ({
  ...
  const handleCardClick = () => {
    if (onDetails) {
      ...
      navigate(`/consultation-request/${request.id}`);
    }
  };
