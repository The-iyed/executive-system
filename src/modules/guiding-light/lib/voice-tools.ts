...
export const realtimeTools = [
  ...
  },
  {
    ...
    description: "تلخيص وإحصائيات الاجتماعات. استخدمها فقط عند طلب صريح للتلخيص أو الإحصائيات. النتيجة تحتوي على total_meetings وهو العدد الصحيح للاجتماعات، استخدم هذا الرقم دائماً ولا تعد الاجتماعات يدوياً.",
    parameters: {
      type: "object",
      properties: {
        start_date: { type: "string", description: "Start date in YYYY-MM-DD format." },
...
- انتبه لنطق كلمة "المُجدوَلة" بشكل صحيح (بضم الميم وفتح الواو)، ولا تنطقها "المَجدولة"
