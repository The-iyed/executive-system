...
import { FormTable, MINISTER_SUPPORT_TYPE_OPTIONS, PRESENTATION_DURATION_MINUTES_OPTIONS, type FormTableColumn, type FormTableRow } from '@shared';
import { getAgendaTotalDurationMinutes } from '../../schemas/step1BasicInfo.schema';
