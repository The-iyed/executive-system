...
import { ChevronRight, ChevronUp, ChevronDown, Send, Eye, Download, RotateCcw, Upload, ClipboardCheck, GitCompare, MessageSquare, Clock, User, Mail, Phone, Trash2 } from 'lucide-react';
